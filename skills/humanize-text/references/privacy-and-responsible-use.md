...
- The public package contains instructions and connection metadata; it does not contain the proprietary rewriting engine or service credentials.
...
Use Humanizer PRO for text the user owns or has permission to edit. Preserve citations and factual meaning. Remind users that they remain responsible for academic, workplace, client, publisher, and platform rules.

Naturalness and detector scores are probabilistic signals. Never guarantee a detector result, authorship judgment, grade, publication outcome, or policy compliance.
